...
public class FriendsPairingBottomUpDPSpaceOptimized{
	...
	public static long friendsPairingBottomUpDPSpaceOptimized(int n){
		long a = 1;	// a = dp[0] = 1
		long b = 1;	// b = dp[1] = 1
		for(long i=2; i<=n; i++){
			long c = b + (i-1) * a;
	...
	public static void main(String[] args){
		...
		System.out.println("No of Ways to seat " + n + " person on Bikes: " 
			+ friendsPairingBottomUpDPSpaceOptimized(n));
	}
}
